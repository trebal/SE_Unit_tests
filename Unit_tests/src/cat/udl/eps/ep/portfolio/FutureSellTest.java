...
public class FutureSellTest {
    private FutureSell futureSell;

    @Before
    public void initFutureSell() {
        futureSell = new FutureSell(new Ticket("BTC"), 10, new Money(new BigDecimal("10.00"), new Currency("EUR")));
    }
    ...
    public void testEvaluate() throws EvaluationException {
        ...
        Money result = futureSell.evaluate(currencyTo, moneyExchangeImpl, stockExchangeImpl);
    ...
    public void testEvaluateExchangerHasNoRatio() throws EvaluationException {
        ...
        futureSell.evaluate(currencyTo, moneyExchangeImpl, stockExchangeImpl);
    }
